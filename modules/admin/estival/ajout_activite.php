...
$result=$estival->infosActivite($_GET["id_activite"]);
...
?>
   ...
   <div class="col-md-4">        
    ...
    <span class="fa fa-link"></span>
     ...
     <input type="text" class="form-control"  value="<?php if(isset($result[7])) {echo $result[7];} ?>" placeholder="Association" required name="association" data-error="Veuillez saisir une association"></div>  
     <div class="help-block with-errors"></div>
 ...
 <div class="form-group has-feedback">
  ...
  <div class="form-group has-feedback">
                  ...
                  <input class="form-control" type="text"  value="<?php if(isset($result[10])) {echo $result[10];} ?>" placeholder="Public" required name="public" data-error="Veuillez saisir un type de public"> </div>
                   <div class="help-block with-errors"></div>
</div></div>
