...
$result=$annuel->ajoutActivite($_POST['nom'],$_POST['date'],$_POST['heure_debut'],$_POST['heure_fin'],$_POST['description'],$_POST['association'],$_POST['lieu'],$_POST['repli'],$_POST['public'],$_POST['limite'],$_POST['couleur']);
