...
<div class="form-group has-feedback">
     ...
     <!-- /.box -->         
          ...
          <div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title">Suppression d'un membre inscrit</h3>
   <div class="box-tools pull-right">
      <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
       <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
...
echo"<tr>
            ...
            <td style=\"width: 30%; text-align: left\">$nom</td>
            <td style=\"width: 30%; text-align: left\">$prenom</td>
            <td style=\"width: 20%; text-align: left\">$naissance</td>
            <td style=\"width: 15%; text-align: center\"><a href=\"#\" onclick=\"suppUser($id_activite,$id,new String('$nomjs'));\"><span class=\"label label-danger\">&nbsp;Supp.&nbsp;&nbsp;<i class=\"fa fa-trash-o\"></i></span></a></td>
...
?>
  ...
  <table id="nouser" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                      	<th>#</th>
                        <th>Nom</th>
...
$data=$annuel->afficheNoUsers($id_activite); 
...
echo"<tr>
            ...
            <td style=\"width: 30%; text-align: left\">$prenom</td>
            <td style=\"width: 20%; text-align: left\">$naissance</td>
            <td style=\"width: 15%; text-align: center\"><a href=\"add_user.php?id_user=".$id."&id_activite=".$id_activite."&origine=".$origine."\"><span class=\"label label-info\">&nbsp;Ajouter&nbsp;&nbsp;<i class=\"fa fa-plus-circle\"></i></span></a></td>
