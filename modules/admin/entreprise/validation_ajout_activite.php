...
$result=$entreprise->ajoutActivite($_POST['nom'],$_POST['date'],$_POST['heure_debut'],$_POST['heure_fin'],$_POST['description'],$_POST['lieu'],$_POST['repli'],$_POST['limite'],$_POST['couleur']);
