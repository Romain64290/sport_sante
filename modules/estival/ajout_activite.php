...
/* Article exemple */
$id = $_GET['ajout'];
$verif=$fo_estival->verif_panier($id);

if($verif==true){}else{


// affiche les infos de l'activité selectionnée
$result = $fo_estival->afficheInfoActivite($id);
 
$titre=$result[0]->titre_estival_activite;

$date=$result[0]->start_estival_activite;
$date=explode(" ",$date);
$jour=explode("-",$date[0]);
...
$color2=$result[0]->color_selection_estival_activite;
