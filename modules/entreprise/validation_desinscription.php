...
<div class="box box-solid box-success">
 ...
 <?php 
  ...
  // echo afficheActiviteSupprimee($id_user,$id_activite,$email);
   
 
// verifie si l'activité a supprime existe   
$verifiSuppressionActivite=$fo_entreprise->verifiSuppressionActivite($id_user,$id_activite,$email);

  // si elle existe... 
if ($verifiSuppressionActivite ==1){
	
// supprime	la laison en l'activite et l'user.
$fo_entreprise->suppUser($id_activite,$id_user);
	
	
// affiche l'activite supprimee
$affichgeactivitesup=$fo_entreprise->afficheactivitesupprime($id_activite);
